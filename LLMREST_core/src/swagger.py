...
from LLMREST_core.src.factor import *
from LLMREST_core.src.rest import *
...
class SwaggerParser:
    def __init__(self, spec_file: str = None, server: str = None):
    ...
    def _extract_body_param(body: RequestBody):
        ...
        factor: AbstractFactor = SwaggerParser._extract_factor("body", content.schema, body.required)
    ...
    @staticmethod
    def _extract_factor(name: str, schema: Schema, body_required=False):
        ...
        if len(schema.enum) > 0:
            ...
            factor = SwaggerParser._build_object_factor(name, schema, body_required)
    ...
    @staticmethod
    def _build_object_factor(name: str, schema: Object,  body_required=False):
